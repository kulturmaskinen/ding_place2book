...
jQuery(document).ready(function($) {
	$('.place2book-ticketinfo').each(function() { 
	    var obj = this;
            $(obj).parent().append("<div class='p2b_preloader'><a href='https://place2book.com/da/14540/list/EM3892'>Henter billetstatus – klik for at gå til arrangementsoversigt hos billetudbyder</a><i class='fa fa-cog fa-spin fa-2x fa-fw'></i><div>");
