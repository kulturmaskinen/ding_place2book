...
jQuery(document).ready(function($) {
	$('.place2book-ticketinfo').each(function() { 
	    var obj = this;
            $(obj).parent().append("<div class='p2b_preloader'><a href='https://place2book.com/da/14540/list/EM3892'>Bestil billet(ter)</a><i class='fa fa-cog fa-spin fa-2x fa-fw'></i><div>");
